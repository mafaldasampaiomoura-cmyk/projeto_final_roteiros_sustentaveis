...
exports.deleteRoute = exports.updateRoute = exports.createRoute = exports.getRouteById = exports.listRoutes = void 0;
const supabase_1 = require("../config/supabase");
const listRoutes = async (req, res) => {
    const { duration } = req.query;
    let query = supabase_1.supabase.from('routes').select('*');
    if (duration) {
